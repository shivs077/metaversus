...
const NewFeatures = ({ imgUrl, title, subtitle }) => {
  return (
    <div className="flex-1 flex flex-col max-w-[240px] md:max-w-[unset] min-w-[210px]">
      <div className={`${styles.flexCenter} w-[70px] h-[70px] rounded-[24px] bg-[#323f5d]`}>
        <Image src={imgUrl} alt="icon" className="w-1/2 h-1/2 object-contain" width={35} height={35} />
      </div>
